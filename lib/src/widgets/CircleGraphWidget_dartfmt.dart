...
class CircleGraphWidget extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Rect rect = Rect.fromLTWH(-150.0, 30.0, 300.0, 300.0);
    ...
    if (macros.isNotEmpty) {
      ...
      for (var macro in macros) {
        ...
        canvas.drawArc(
            rect, math.radians(lastDouble), math.radians(sweep), false, paint);
        ...
        canvas.drawArc(rect, math.radians(lastDouble), math.radians(percent),
            false, paint);
